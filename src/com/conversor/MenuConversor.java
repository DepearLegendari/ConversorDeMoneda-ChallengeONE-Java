    ...
    private void realizarConversion() {
        ...
        while (continuarConversion) {
            try{
                ...
                System.out.println("==============================");
                // 6. Selección, validación, cálculo y guardado en el historial (memoria)
                historial.agregar(from, to, amount, resultado);
                // Guardar en archivo (persistir)
                historial.guardarUltimoEnArchivo("historial_conversiones.txt");
